...
var expectedFailures = []string{
	...
	"TestNormalization/prelude/Bool/and/0A",
	"TestNormalization/prelude/Bool/even/1A",
	"TestNormalization/prelude/Bool/even/2A",
	"TestNormalization/prelude/Bool/odd/1A",
	"TestNormalization/prelude/Bool/odd/2A",
	"TestNormalization/prelude/Bool/or/0A",
	"TestNormalization/prelude/Double",
	"TestNormalization/prelude/Integer",
	"TestNormalization/prelude/List/all",
	"TestNormalization/prelude/List/any",
	"TestNormalization/prelude/List/concat",
	"TestNormalization/prelude/List/filter",
	"TestNormalization/prelude/List/generate",
	"TestNormalization/prelude/List/head",
	"TestNormalization/prelude/List/indexed",
	"TestNormalization/prelude/List/iterate",
	"TestNormalization/prelude/List/last",
	"TestNormalization/prelude/List/length",
	"TestNormalization/prelude/List/map",
	"TestNormalization/prelude/List/null",
	"TestNormalization/prelude/List/replicate",
	"TestNormalization/prelude/List/reverse",
	"TestNormalization/prelude/List/shifted",
	"TestNormalization/prelude/List/unzip",
